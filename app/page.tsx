            ...
            <div className="grid max-w-xl grid-cols-1 gap-8 text-base leading-7 text-gray-300 lg:max-w-none lg:grid-cols-2">
              <div>
                <p>
                  ...
                  Whether you're looking to share your expertise, learn from
                  others, or simply engage in stimulating conversations, you'll
                  find a welcoming and supportive community here.
                </p>
                <p className="mt-8">
        ...
        <div className="mx-auto max-w-7xl px-6 pb-8 lg:px-8">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="space-y-8">
              ...
              <p className="text-sm leading-6 text-gray-300">
                Our forum is a place for meaningful conversations and knowledge
                sharing. Join us and be part of our growing community.
              </p>
          ...
          <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
            <p className="text-xs leading-5 text-gray-400">
              &copy; 2020 Your Forum, Inc. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
